    ...
    <!--export default {-->
        ...
        <!--methods: {-->
            <!--init() {   //初始化 table的数据-->
                ...
                <!--this.$axios.post('/api/table_msg_xxjs',{type:5}).then(res => {-->
                    <!--if (res.status === 200) {-->
            ...
            <!--failuredRadio(radio, id, index, tableKey) {//合格不合格-->
                ...
                <!--this.$axios.post('/api/isFailure_xxjs', 'post', {-->
                    <!--id: id,-->
                    <!--type: radio-->
                <!--}).then(res => {-->
                    <!--if (res.status == 200) {-->
            ...
            <!--},-->
            <!--allChecked() {//全选-->
                <!--this.$axios.post('/api/allChecked_xxjs', 'post', {-->
                    <!--// id:id-->
                <!--}).then(res => {-->
                    <!--if (res.status === 200) {-->
                        <!--for (var i = 0; i < this.radioArr.length; i++) {-->
            ...
            <!--allSubmit() {-->
                ...
                <!--if (this.isAllFilled()) {-->
                    <!--this.$axios.post('/api/alltijiao_xxjs', {type:5}, {-->
                        <!--// id:id,-->
                        <!--// status:status,-->
                    <!--}).then(res => {-->
                        <!--if (res.status == 200) {-->
            ...
            <!--/*-&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45; zTree end &#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;*/-->
            <!--check_pdf(i, obj) {-->
                <!--this.$axios.post('/api/check_pdf_xxjs', 'post', {-->
                    <!--id: obj.id-->
                <!--}).then(res => {-->
                    <!--if (res.status === 200) {-->
...
<template>
    <div>
        <startVauation :type="type">></startVauation>
        <!--<start-evaluation :type="type"></start-evaluation>-->
    </div>
</template>

<script>
    import startVauation from '../../components/publicVue/startVauation.vue';
    export default {
        name: "start-evaluation-xxjs",
        components: {
            startVauation
        },
        data() {
