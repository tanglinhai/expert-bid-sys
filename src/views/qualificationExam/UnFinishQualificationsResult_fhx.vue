    ...
    <!--export default {-->
        ...
        <!--methods: {-->
            <!--init() {   //初始化 table的数据-->
                ...
                <!--this.$axios.post('/api/table_data_fhx',  {//通过包id-->
                    <!--// id:id-->
                    <!--type:4-->
                <!--}).then(res => {-->
                    <!--if (res.status === 200) {-->
                        ...
                        <!--console.log(res.data.bidMsg.eviewrItemsMsg.msgBox);-->
            ...
            <!--},-->
            <!--submit(){-->
                <!--this.$axios.post('/api/tijiao_fhx', {type:4}, {-->
                    <!--data:this.form.desc-->
                <!--}).then(res => {-->
                    <!--if(res.status==200){-->
...
<template>
    <div>
        <UnFinishQualifications :type="type">></UnFinishQualifications>
    </div>
</template>

<script>
    import UnFinishQualifications from '../../components/publicVue/UnFinishQualifications.vue';
    export default {
        name: "",
        components: {
            UnFinishQualifications
        },
        data() {
            return {
                type: 5
